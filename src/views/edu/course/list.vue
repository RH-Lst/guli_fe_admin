...
<!--查询表单-->
    ...
    <!-- 讲师 -->
        <el-form-item>
        <el-select row-class-name="myClassList" v-model="courseQuery.teacherId" placeholder="请选择讲师">
        <el-option
...
<!-- 表格 -->
    ...
    <el-table-column label="操作" width="150" align="center">
        ...
        <el-button type="text" size="mini" icon="el-icon-delete" @click="deleteCoure(scope.row.id)">删除课程</el-button>
        </template>
    </el-table-column>
    </el-table>
<!-- 分页 -->
